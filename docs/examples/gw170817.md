...
# Observational data
data_radio_uJy = np.array([
    [16.4,15.1,3.4],[22.2,18.0,4.5],[35.2,22.0,4.0],[46.3,28.5,4.0],
    [54.3,33.0,4.5],[65.5,40.0,4.5],[75.4,44.0,4.0],[92.6,52.0,5.0],
    [107.5,60.0,4.5],[115.2,62.0,5.0],[135.8,67.0,5.0],[152.2,70.0,5.0],
    [163.1,68.0,6.0],[185.5,56.0,5.5],[207.4,52.0,5.0],[230.0,48.0,6.0],
    [260.0,40.0,5.0],[298.0,32.0,5.0],[362.0,24.0,5.0],[581.0,12.0,3.5],
    [900.0,5.5,2.5],
])
data_xray_nJy = np.array([
    [9.2,0.85,0.45],[15.4,1.9,0.5],[109.2,5.5,0.8],[135.0,5.6,0.7],
    [153.5,6.4,0.8],[163.0,6.5,0.6],[186.0,5.0,0.7],[209.0,4.2,0.6],
    [260.0,3.3,0.5],[358.0,1.7,0.4],[581.0,0.80,0.30],[743.0,0.50,0.25],
])

P = {
    "Eiso": 2e52, "lf": 300.0, "theta_c": 0.07, "A": 0.0, "n0": 1.5e-3,
    "eps_e": 0.1, "eps_b": 3e-3, "p": 2.10,
    "theta_v": 0.55, "d": 40.0, "z": 0.0098,
}
...
ax1.legend()
ax1.set_xlim(5, 1200); ax1.set_ylim(1, 200)
ax1.tick_params(which="both", direction="in", top=True, right=True)

# X-ray (plot in nanoJy)
...
ax2.legend()
ax2.set_xlim(5, 1200); ax2.set_ylim(0.1, 20)
